...
public class IndianMobileNumberValidator implements ConstraintValidator<IndianMobileNumber, String> {
    ...
    public boolean isValid(String value, ConstraintValidatorContext context) {
        // Blank/null is allowed here — member profiles are auto-created on
        // first login before a phone number is collected. Format is only
        // enforced once a value is actually supplied (e.g. member fills it
        // in later via their profile).
