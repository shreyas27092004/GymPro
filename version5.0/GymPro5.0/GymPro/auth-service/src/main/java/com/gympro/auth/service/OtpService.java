...
public class OtpService {
    ...
    // ════════════════════════════════════════════════════════════════════════
    //  STEP 3: Reset Password  (now rejects reuse of the current password)
    // ════════════════════════════════════════════════════════════════════════
    ...
    public ForgotPasswordResponse resetPassword(ResetPasswordRequest req) {
        ...
        // Enterprise validation: new password must differ from the current
        // encrypted password. Uses PasswordEncoder#matches so raw new password
        // is compared against the stored BCrypt hash — never decrypted, never
        // stored/logged in plain text.
