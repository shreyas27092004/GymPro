...
public class NotificationEvent implements Serializable {
    ...
    public static NotificationEvent refundRequested(String memberEmail, Double amount, String txnId,
        ...
        NotificationEvent e = new NotificationEvent();
        e.eventType = "REFUND_REQUESTED"; e.recipientEmail = memberEmail;
        e.amount = amount; e.txnId = txnId; e.paymentId = paymentId; e.description = reason;
        return e;
    }

    public static NotificationEvent refundApproved(String memberEmail, Long memberId,
                                                     Double amount, String txnId, Long paymentId) {
        NotificationEvent e = new NotificationEvent();
        e.eventType = "REFUND_APPROVED"; e.recipientEmail = memberEmail;
        e.userId = memberId; e.userRole = "MEMBER";
        e.amount = amount; e.txnId = txnId; e.paymentId = paymentId;
        return e;
    }

    public static NotificationEvent refundRejected(String memberEmail, Long memberId,
                                                     Double amount, String txnId, Long paymentId, String adminNote) {
        NotificationEvent e = new NotificationEvent();
        e.eventType = "REFUND_REJECTED"; e.recipientEmail = memberEmail;
        e.userId = memberId; e.userRole = "MEMBER";
        e.amount = amount; e.txnId = txnId; e.paymentId = paymentId; e.description = adminNote;
        return e;
    }

    public static NotificationEvent refundCompleted(String memberEmail, Long memberId,
                                                      Double amount, String txnId, Long paymentId) {
        NotificationEvent e = new NotificationEvent();
        e.eventType = "REFUND_COMPLETED"; e.recipientEmail = memberEmail;
        e.userId = memberId; e.userRole = "MEMBER";
        e.amount = amount; e.txnId = txnId; e.paymentId = paymentId;
        return e;
    }
