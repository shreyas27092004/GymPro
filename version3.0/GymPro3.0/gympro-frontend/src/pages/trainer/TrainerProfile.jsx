        ...
        <div className="card" style={{ maxWidth: 640 }}>
          ...
          {trainer.sessionFee == null && (
            <div style={{
              ...
              <Icon name="alertTriangle" size={13} style={{ marginRight: 4, verticalAlign: '-2px' }} />You haven't set a session fee yet. Members cannot complete paid bookings with you until you configure one.
            </div>
          )}
