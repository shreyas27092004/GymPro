...
public class NotificationEvent implements Serializable {
    ...
    public static NotificationEvent bookingConfirmed(String memberEmail, Long bookingId,
    ...
    public static NotificationEvent bookingToTrainer(String trainerEmail, Long bookingId,
    ...
    public static NotificationEvent bookingCancelled(String memberEmail, Long bookingId) {
        NotificationEvent e = new NotificationEvent();
    ...
    public static NotificationEvent paymentSuccess(String memberEmail, Double amount,
    ...
    public static NotificationEvent paymentRefund(String memberEmail, Double amount, String txnId) {
        NotificationEvent e = new NotificationEvent();
    ...
    /** New admin registration awaiting approval → sent to ONE existing admin's email */
    public static NotificationEvent adminRegistrationCode(String existingAdminEmail, String otp,
        ...
        NotificationEvent e = new NotificationEvent();
        e.eventType      = "ADMIN_REGISTRATION_CODE";
        e.recipientEmail = existingAdminEmail;
        e.otp            = otp;
        e.newAdminName   = newAdminName;
        e.newAdminEmail  = newAdminEmail;
        return e;
    }

    /** Plan activated → member */
    public static NotificationEvent planActivated(String memberEmail, String planName,
    ...
    public void   setNewAdminName(String newAdminName) { this.newAdminName = newAdminName; }
