...
const TYPE_META = {
  BOOKING: { icon: 'calendar',  color: '#00d4ff' },
  PAYMENT: { icon: 'card',      color: '#00e5a0' },
  PLAN:    { icon: 'checkCircle', color: '#a78bfa' },
  SYSTEM:  { icon: 'settings',  color: '#ffd700' },
};

function getMeta(type) {
  return TYPE_META[type] || { icon: 'bell', color: '#00d4ff' };
}
      ...
      {open && (
        <div style={{
          ...
          <div style={{
            ...
            <span style={{ fontWeight: 700, color: 'var(--text)', fontSize: 14, display: 'flex', alignItems: 'center', gap: 6 }}>
          ...
          <div style={{ maxHeight: 380, overflowY: 'auto' }}>
            {loading && notifications.length === 0 ? (
              ...
              <div style={{ padding: 32, textAlign: 'center', color: 'var(--text3)', fontSize: 13 }}>
                <div style={{ marginBottom: 8, display: 'flex', justifyContent: 'center' }}><Icon name="bellOff" size={28} /></div>
