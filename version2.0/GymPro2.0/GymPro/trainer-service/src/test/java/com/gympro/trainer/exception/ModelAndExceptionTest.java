...
class ModelAndExceptionTest {
    ...
    void trainerSchedule_allArgsConstructor_setsAllFields() {
        TrainerSchedule schedule = new TrainerSchedule(2L, 1L, "WED", "10:00", "12:00", true);

        assertEquals(2L, schedule.getId());
        assertEquals(1L, schedule.getTrainerId());
        assertEquals("WED", schedule.getDayOfWeek());
    ...
    void trainerSchedule_setters_updateFields() {
        ...
        assertEquals("FRI", schedule.getDayOfWeek());
    ...
    void trainerSchedule_equalsAndHashCode() {
        TrainerSchedule s1 = new TrainerSchedule(1L, 1L, "MON", "09:00", "11:00", true);
        TrainerSchedule s2 = new TrainerSchedule(1L, 1L, "MON", "09:00", "11:00", true);
    ...
    void trainerSchedule_toString_isNotNull() {
        TrainerSchedule schedule = new TrainerSchedule(1L, 1L, "MON", "09:00", "11:00", true);
        assertNotNull(schedule.toString());
        assertTrue(schedule.toString().contains("MON"));
    }
