...
@OpenAPIDefinition(
    info = @Info(
        title       = "GymPro – Booking Service API",
        version     = "1.0.0",
        description = "Manage training session bookings: create, view, cancel, and complete bookings.",
        contact     = @Contact(name = "GymPro Team", email = "support@gympro.com")
    ),
    servers  = @Server(url = "http://localhost:8085", description = "Local – Booking Service"),
