  ...
  return (
    <div className="fade-in">
      ...
      <div className="content-body">
            ...
            <div key={plan.id} className="card fade-in" style={{ position: 'relative', borderColor: plan.active ? 'var(--border)' : 'rgba(255,91,110,0.3)' }}>
              ...
              <div style={{ marginBottom: 14 }}>
                <span style={{
                  ...
                  🎟️ {plan.sessionsIncluded ?? 0} Free Session{plan.sessionsIncluded !== 1 ? 's' : ''}
                </span>
              </div>
        ...
        {!loading && plans.length === 0 && <EmptyState icon="📋" text="No plans created yet" />}
    ...
    <Modal title={initial ? 'Edit Plan' : 'Create Plan'} onClose={onClose}>
      <form onSubmit={submit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
        ...
        <div style={{
          ...
          🎟️ Members on this plan will receive <strong style={{ color: 'var(--green)' }}>{form.sessionsIncluded || 0} free trainer session{form.sessionsIncluded !== 1 ? 's' : ''}</strong> included in their membership. Payment is required after this limit.
        </div>
